...
from src.mlproject01.utils import save_object
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Reading train and test file from data transformation..")
            ...
            save_object(
                filepath=self.data_transformation_config.prepocessor_obj_file_path,
